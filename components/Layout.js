...
export default function Layout({ children, meta: pageMeta, isMarkdown }) {
    ...
    <>
      ...
      {isMarkdown ?
        <div id="skip">
          {meta.cover_image
            ?
            <div className={styles.image_wrapper}><Image src={meta.cover_image} width={800} height={600} className="m-auto" /></div>
            :
            null}
          <article
